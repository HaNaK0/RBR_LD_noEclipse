...
class NewProject(tk.Toplevel):
    ...
    def __init__(self, master, main):
        ...
        tk.Label(self, text="the height and width of every cell in the grid.").grid(row=3, column=0, columnspan=2,
                                                                                    sticky=tk.W)
        ...
        self.button = tk.Button(self, text="Cancel", command=self.cancelButtonPressed).grid(row=6, column=1,
                                                                                            sticky=tk.W)
...
class OptionsDialaog(tk.Toplevel):
    """
    An options dialog
    ...
    def __init__(self, master, controlDict):
        ...
        The constructor
        """
        super(OptionsDialaog, self).__init__(master)
        self.grid()
